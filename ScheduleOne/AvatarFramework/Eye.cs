		...
		public void Blink(float blinkDuration, EyeLidConfiguration endState, bool debug = false)
		{
			...
			IEnumerator Routine()
			{
				...
				for (float i = 0f; i < duration; i += Time.deltaTime)
				{
					...
					eyeLidConfiguration.bottomLidOpen = Mathf.Lerp(start.bottomLidOpen, end.bottomLidOpen, i / duration);
					eyeLidConfiguration.topLidOpen = Mathf.Lerp(start.topLidOpen, end.topLidOpen, i / duration);
